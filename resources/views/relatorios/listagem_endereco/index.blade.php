...
@section('conteudo')
    <div class="panel panel-flat">
        <form action="{{ route('relatorio_estoque.listagem_endereco') }}" method="GET">
                    ...
                    @if ($usuarioLogado->super_admin || $usuarioLogado->gestor)
                        <div class="col-sm-3 col-md-3 col-lg-3">
                            <div class="form-group">
                                <label>Unidade:</label>
                                <select name="unidade_id" class="form-control select2 carregar-secoes"
                                        data-target="secao_id" required>
                                    <option></option>
    ...
    @include('partials.painel_registros', [
        'listagem' => 'relatorios.listagem_endereco.listagem',
        'prefixo' => 'estoque'
    ])
@endsection
