                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>Rua:</label>
                                <input  type="number" class="form-control" v-model="obj_rua.q_rua" >
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>Módulos:</label>
                                <input  type="number" class="form-control" v-model="obj_rua.q_modulo" >
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>Nível:</label>
                                <input  type="number" class="form-control" v-model="obj_rua.q_nivel" >
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>Vão:</label>
                                <input  type="number" class="form-control" v-model="obj_rua.q_vao" >
                            </div>
                        </div>
                    </div>
